...
def execute_evaluator_entry(*, request: Mapping[str, Any], relationship: Mapping[str, Any], local_reference_executor: Callable[[str, int], Mapping[str, Any]]) -> dict[str, Any]:
    ...
    The callback is host-injected and receives no credential, provider-selection,
    route-registry, repository, wallet, heartbeat, or sovereign authority from
    the evaluator request.
    """
