...
def stegverse_node_advertisement(request: Request) -> dict:
    ...
    payload = {
        ...
        "resident_rendezvous_discovery_endpoint": f"{base_url}/api/resident-rendezvous/v1/discovery",
        "resident_rendezvous_advertisement_endpoint": f"{base_url}/api/resident-rendezvous/v1/advertisements",
        "resident_rendezvous_current_request_id": "RESIDENT-EXEC-STEGOS-KV-INTR-CHAIN-003",
        "resident_rendezvous_discovery_grants_authority": False,
