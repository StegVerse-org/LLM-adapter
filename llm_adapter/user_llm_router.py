...
Transport functions are injected so this module can be tested without network access.
"""
...
def handle_user_llm_request(
    ...
    """Dictionary-based service boundary suitable for FastAPI/MCP/SDK wrappers."""
    try:
        ...
        identity = UserLLMIdentity(
            ...
            scopes=tuple(identity_data.get("scopes") or ()),
        )
