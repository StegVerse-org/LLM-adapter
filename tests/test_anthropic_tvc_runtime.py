...
from llm_adapter.anthropic_intr_transport import build_anthropic_intr_envelope
...
def _envelope(req):
    return build_anthropic_intr_envelope(req, transition_id="tx-1", ingress_disposition="ALLOW", ingress_receipt_hash="a"*64, carrier_ref="carrier-1", max_tokens=2048)
