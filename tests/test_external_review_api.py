...
def package() -> dict:
    return {
        ...
        "package_id": "review-package:test:001",
        "framework_id": "decisionassure",
        "compatibility_receipt_id": "external-compatibility-receipt:sha256:test",
...
def correction() -> dict:
    return {
        ...
        "schema_version": "1.0.0",
        "package_id": "review-package:test:001",
        "challenged_receipt_id": "external-compatibility-receipt:sha256:test",
...
def test_package_only_intake_is_authenticated_append_only_and_idempotent(monkeypatch, tmp_path):
    ...
    unauthorized = client.post("/api/external-review/packages", json=package())
...
def test_scope_and_identity_drift_fail_closed(monkeypatch, tmp_path):
    ...
    drift = correction()
    drift["challenged_submission_sha256"] = "b" * 64
