...
def main() -> int:
    ...
    require(".github/workflows/stegdeploy-image.yml", "packages: write", "id-token: write", "attestations: write", "docker/build-push-action@v6", "actions/attest-build-provenance@v2", "stegdeploy.image-publication.v2", '"manual_credentials_required": False')
