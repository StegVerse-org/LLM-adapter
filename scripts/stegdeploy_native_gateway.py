...
def main() -> int:
    ...
    start_p.add_argument("--enable-evaluator-intr", action="store_true")
    start_p.add_argument("--evaluator-upstream", default="http://127.0.0.1:8765/intr/evaluator")
    start_p.add_argument("--tls-cert-file", type=Path)
    start_p.add_argument("--tls-key-file", type=Path)
