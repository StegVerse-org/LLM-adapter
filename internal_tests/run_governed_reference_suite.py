...
def receipt_chain_test() -> dict[str, Any]:
    ...
    chain = []
    for event in events:
        receipt = {"event": event, "previous_receipt_hash": previous}
...
def main() -> int:
    ...
    tests = [
        case("GOV-001", "Valid standing and unchanged policy allow bounded execution.",
        ...
        case("GOV-002", "Expired delegation denies at commit time.",
             ...
             lambda: decision_observation(standing="VALID", delegation_expires=expired_at,
                 revoked=False, policy_hash_at_review=policy_v1, policy_hash_at_commit=policy_v1)),
        case("GOV-003", "Revocation before commit overrides earlier validity.",
        ...
        case("GOV-004", "Invalid standing denies despite valid delegation.",
             ...
             lambda: decision_observation(standing="INVALID", delegation_expires=valid_until,
                 revoked=False, policy_hash_at_review=policy_v1, policy_hash_at_commit=policy_v1)),
        case("GOV-005", "Policy mutation after review denies commit.",
        ...
        case("GOV-006", "Restricted request remains fail-closed without separate authority.",
             {"restricted": True},
        ...
        case("GOV-007", "Receipt chain replays deterministically.",
             {"events": ["submission", "decision", "receipt"]},
             {"replay_valid": True, "chain_length": 3, "authority_effect": "NONE"},
             receipt_chain_test),
        case("GOV-008", "Serialized transition state survives a restart simulation.",
             {"transition_id": "transition-restart-001"},
